		...
		<Body style={main}>
			<Container style={container}>
				...
				<Text style={paragraph}>
					Thank you purchasing on Tech Academy . Click on Below download button to download the all digital content
				</Text>
				...
				<Text style={paragraph}>
					Best,
					<br />
					Dev Mohammed Mansour
				</Text>
				<Hr style={hr} />
				<Text style={footer}>Subscribe to Tech Ecommerce </Text>
			</Container>
		</Body>
	</Html>
);
